...
TEST (conflicts, adjusted_difficulty)
{
	...
	ASSERT_EQ (0, node1.active.size ());
	node1.active.start (genesis.open);
	auto send1 (std::make_shared<btcb::send_block> (genesis.hash (), key1.pub, btcb::genesis_amount - 2 * btcb::bcb_ratio, btcb::test_genesis_key.prv, btcb::test_genesis_key.pub, system.work.generate (genesis.hash ())));
	node1.process_active (send1);
	auto send2 (std::make_shared<btcb::send_block> (send1->hash (), btcb::test_genesis_key.pub, btcb::genesis_amount - 3 * btcb::bcb_ratio, btcb::test_genesis_key.prv, btcb::test_genesis_key.pub, system.work.generate (send1->hash ())));
	...
	auto send3 (std::make_shared<btcb::state_block> (key1.pub, open1->hash (), key1.pub, btcb::bcb_ratio, key2.pub, key1.prv, key1.pub, system.work.generate (open1->hash ())));
	...
	auto receive2 (std::make_shared<btcb::state_block> (key2.pub, open_epoch1->hash (), 0, btcb::bcb_ratio, send3->hash (), key2.prv, key2.pub, system.work.generate (open_epoch1->hash ())));
	node1.process_active (receive2);
	auto open2 (std::make_shared<btcb::state_block> (key3.pub, 0, key3.pub, btcb::bcb_ratio, send4->hash (), key3.prv, key3.pub, system.work.generate (key3.pub)));
	node1.process_active (open2);
	auto change1 (std::make_shared<btcb::state_block> (key3.pub, open2->hash (), btcb::test_genesis_key.pub, btcb::bcb_ratio, 0, key3.prv, key3.pub, system.work.generate (open2->hash ())));
