...
run_build() {
    ...
    scl enable llvm-toolset-7 devtoolset-7 'rpmbuild -ba btcbcurrency.spec'
    scl enable llvm-toolset-7 devtoolset-7 'rpmbuild -ba btcbcurrency-beta.spec'
}

run_update() {
    for file in ./btcbcurrency*.in; do
