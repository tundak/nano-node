...
// SI dividers
nano::uint128_t const Gbcb_ratio = nano::uint128_t ("10000000000000000000000000000000000000"); // 10^37
nano::uint128_t const Mbcb_ratio = nano::uint128_t ("10000000000000000000000000000000000"); // 10^34
nano::uint128_t const kbcb_ratio = nano::uint128_t ("10000000000000000000000000000000"); // 10^31
nano::uint128_t const bcb_ratio = nano::uint128_t ("10000000000000000000000000000"); // 10^28
