...
TEST (mdb_block_store, sideband_height)
{
	...
	nano::state_block epoch (key1.pub, state_open.hash (), 0, nano::Gbcb_ratio, ledger.epoch_link (nano::epoch::epoch_1), nano::test_genesis_key.prv, nano::test_genesis_key.pub, *pool.generate (state_open.hash ()));
