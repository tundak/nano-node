...
TEST (bootstrap_processor, pull_requeue_network_error)
{
	...
	nano::genesis genesis;
	nano::keypair key1;
	auto send1 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::Gbcb_ratio, key1.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
...
TEST (bootstrap_processor, frontiers_unconfirmed)
{
	...
	auto send2 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, send1->hash (), nano::test_genesis_key.pub, nano::genesis_amount - 2 * nano::Gbcb_ratio, key2.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, *system.work.generate (send1->hash ())));
	ASSERT_EQ (nano::process_result::progress, node1->process (*send2).code);
	auto open1 (std::make_shared<nano::state_block> (key1.pub, 0, key1.pub, nano::Gbcb_ratio, send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
	ASSERT_EQ (nano::process_result::progress, node1->process (*open1).code);
	auto open2 (std::make_shared<nano::state_block> (key2.pub, 0, key2.pub, nano::Gbcb_ratio, send2->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub)));
	...
	auto send3 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, genesis.hash (), nano::test_genesis_key.pub, nano::genesis_amount - nano::bcb_ratio, key1.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
	ASSERT_EQ (nano::process_result::progress, node2->process (*send3).code);
	auto open3 (std::make_shared<nano::state_block> (key1.pub, 0, key1.pub, nano::bcb_ratio, send3->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
...
TEST (bootstrap_processor, lazy_unclear_state_link)
{
	...
	ASSERT_EQ (nano::process_result::progress, node1->process (*send1).code);
	auto send2 (std::make_shared<nano::state_block> (nano::test_genesis_key.pub, send1->hash (), nano::test_genesis_key.pub, nano::genesis_amount - 2 * nano::Gbcb_ratio, key.pub, nano::test_genesis_key.prv, nano::test_genesis_key.pub, *system.work.generate (send1->hash ())));
	ASSERT_EQ (nano::process_result::progress, node1->process (*send2).code);
	auto open (std::make_shared<nano::open_block> (send1->hash (), key.pub, key.pub, key.prv, key.pub, *system.work.generate (key.pub)));
	ASSERT_EQ (nano::process_result::progress, node1->process (*open).code);
	auto receive (std::make_shared<nano::state_block> (key.pub, open->hash (), key.pub, 2 * nano::Gbcb_ratio, send2->hash (), key.prv, key.pub, *system.work.generate (open->hash ()))); // It is not possible to define this block send/receive status based on previous block (legacy open)
	ASSERT_EQ (nano::process_result::progress, node1->process (*receive).code);
	// Start lazy bootstrap with last block in chain known
...
TEST (bootstrap_processor, lazy_destinations)
{
	...
	ASSERT_EQ (nano::process_result::progress, node1->process (*open).code);
	auto state_open (std::make_shared<nano::state_block> (key2.pub, 0, key2.pub, nano::Gbcb_ratio, send2->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub)));
